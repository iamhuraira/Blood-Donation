...
<body>
    <div class="background">
        <div class="t-background">
            ...
            <form id="form" action="addAccount" method="post" name="form">
                <div class="input-box ">
                ...
                <div class="input-box">
                    <input type="number " placeholder="Phone Number" name="phone" id="phone" class="input ">
                ...
                <div class="input-box " >
                    <input type="radio"  name="radio1" value="Admin" class="input radio" ><span class="small">Admin</span>
                ...
                <div class="input-box ">
                    <input type="submit" class="input btn1" value="Add">
    ...
    <script src="./VaddAccount.js"></script>
</body>
